...
class EpisodesControllerTest < ActionController::TestCase
  ...
  test "should create episode" do
    assert_difference('Episode.count') do
      post :create, episode: { description: @episode.description, image_url: @episode.image_url, name: @episode.name }
    end
  ...
  test "should update episode" do
    patch :update, id: @episode, episode: { description: @episode.description, image_url: @episode.image_url, name: @episode.name }
    assert_redirected_to episode_path(assigns(:episode))
  end
